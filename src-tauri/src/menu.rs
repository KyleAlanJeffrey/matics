...
pub fn build<R: Runtime>(app: &AppHandle<R>) -> tauri::Result<Menu<R>> {
    ...
    let file = Submenu::with_items(
        ...
        &[
            ...
            &item(app, "file:open-project", "Open Project...", Some("CmdOrCtrl+O"))?,
            &item(app, "file:open-compressed", "Open Compressed Project...", Some("CmdOrCtrl+Shift+O"))?,
            &separator()?,
            &item(app, "file:save", "Save", Some("CmdOrCtrl+S"))?,
            &item(app, "file:save-compressed", "Save Compressed Copy...", Some("CmdOrCtrl+Shift+S"))?,
            &separator()?,
    ...
    let view = Submenu::with_items(
        ...
        &[
            ...
            &item(app, "view:io", "I/O", Some("CmdOrCtrl+3"))?,
            &item(app, "view:communications", "Communications", Some("CmdOrCtrl+4"))?,
            &item(app, "view:sketches", "Sketches", Some("CmdOrCtrl+5"))?,
            &item(app, "view:report", "Report", Some("CmdOrCtrl+6"))?,
            &separator()?,
