...
const RECORD_FIELDS: [&str; 19] = [
    ...
    "ioModules", "ioSignals", "netInterfaces", "netMappings", "routes", "apis",
];
...
mod tests {
    ...
    const COMPLETE_PROJECT: &str = r#"{"id":"p1","name":"Round trip","presets":{},"devices":{},"buses":{},"zones":{},"connections":{},"bundles":{},"freeWires":{},"images":{},"documents":{},"docLinks":[],"notes":{},"frames":{},"messages":{},"sketches":{},"ioModules":{},"ioSignals":{},"netInterfaces":{},"netMappings":{},"routes":{},"apis":{}}"#;
